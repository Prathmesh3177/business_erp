...
4. Provide technician-scoped mobile workflows, customer document access, service history and operational reports. External email/SMS/WhatsApp sending is not enabled without a selected provider, consent and explicit configuration.
