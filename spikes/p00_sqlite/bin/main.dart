...
void main() {
  ...
  try {
    ...
    if (cipherRows.isEmpty) {
      throw StateError('sqlite3mc is not active');
    }
    ...
    print('PASS cipher=${cipherRows.first.values.first}');
    print('PASS unkeyed_read_rejected=$unkeyedRejected');
    print('PASS wrong_key_rejected=$wrongKeyRejected');
    print('PASS correct_key_round_trip=true');
  } finally {
